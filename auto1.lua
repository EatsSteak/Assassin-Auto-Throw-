...
local tab = ratio.tab
local section = tab.createSection({name = "Auto Throw At Target no silent aim", maxsize = 999})
local section2 = section.createElement({name = "Auto throw no silent aim", type = "button", callback = function()
spawn(function()
